...
<div id="main" class="hander-car">
			<div class="store-content">
									...
									<div class="cart-top-items" v-for="(item,index) in carPanelData"> 
										<div class="cart-items">
											<div class="items-choose">
												<span class="blue-checkbox-new " :class="{'checkbox-on':item.check}" @click="checkCarpanelData(item.sku_id)"><a></a></span>
											</div>
											...
											<div class="item-cols-num">
												<div class="select js-select-quantity">
													...
													<span class="up" :class="{'up-disabled': item.count >=  item.limit_num}" @click="pushCarpanelData(item.sku_id)">+</span>
              ...
              <router-link tag="span" to="/Checkout" class="jianguo-blue-main-btn big-main-btn js-checkout "
                  :class="{'disabled-btn':checkCount<=0}">
              <a>现在结算</a>
...
export default{
   ...
   methods:{
		...
		//增加购物车商品数量
		pushCarpanelData(id){
			return this.$store.commit('pushCarpanelData',id)
		},
		//减少购物车商品数量
		subCarpanelData(id){
		...
		//购物车清单是否选中
		checkCarpanelData(id){
			return this.$store.commit('checkCarpanelData',id)
		},
		//控制全选
		allCheckGoods(allChecked){
			return this.$store.commit('allCheckGoods',allChecked)
		}
   }
}
