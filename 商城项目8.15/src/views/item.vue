				...
				<div class="item-box">
					<div class="gallery-wrapper">
						<div class="gallery">
							<div class="thumbnail" >
								<ul >
									<li :class="{ 'on' :index == imgIndex }" @click="tabImg(index)" :key="index" v-for="img,index in itemInfo.ali_images" >
					...
					<div class="banner">
								...
								<ul class="params-colors">
									<li class="cur" v-for="color,index in itemInfo.sku_list">
									   <router-link :to="{name: 'Item',query:{itemId:color.id}}" :title="color.color"  >
                                             <i><img :src="'http://img01.smartisanos.cn/'+color.image+'20X20.jpg'"></i>
									   </router-link>
						...
						<div class="sku-status">
							<div class="cart-operation-wrapper clearfix">
                                ...
                                <router-link to="/Checkout" ><span class="gray-title-btn"><a>现在购买</a></span></router-link>
...
export default{
	...
	computed: {
		itemInfo(){
	       let itemInfo = this.newItemsData.filter((item) =>{
