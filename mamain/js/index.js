...
$(function () {
	...
	console.log(videoTop, photoTop, traitTop, contactTop)
	$(window).scroll(function () {
		...
		// 滚动到对应位置 导航也变
		if (s < videoTop - navHeight) {
			$('#indexNav ul li').eq(0).addClass('active').siblings("li").removeClass("active");
		}
		if (s > videoTop - navHeight && s < photoTop - navHeight) {
			$('#indexNav ul li').eq(1).addClass('active').siblings("li").removeClass("active");
		}
		if (s > photoTop - navHeight && s < traitTop - navHeight) {
			$('#indexNav ul li').eq(2).addClass('active').siblings("li").removeClass("active");
		}
		if (s > traitTop - navHeight && s < contactTop - navHeight) {
			$('#indexNav ul li').eq(3).addClass('active').siblings("li").removeClass("active");
		}
		if (s > contactTop - navHeight) {
			$('#indexNav ul li').eq(4).addClass('active').siblings("li").removeClass("active");
		}
