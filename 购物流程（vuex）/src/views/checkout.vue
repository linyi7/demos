        ...
        <div class="gray-box">
          ...
          <div class="box-inner"> 
            <div class="last-payment clear"> 
              <span class="jianguo-blue-main-btn big-main-btn payment-blue-bt fn-right js-checkout"> <a>提交订单</a> </span> <span class="prices fn-right">应付金额： <em>¥ {{freight+checkedPrice}}.00</em></span> 
            </div> 
          </div>
        </div>
      </div>
...
export default{
  ...
  computed:{
    checkedGoods(){   //接受store传递过来的选中的商品的数组
      return this.$store.getters.checkedGoods
    },
    checkedPrice(){   //返回计算选中总价的方法
